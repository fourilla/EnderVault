...
public class AdvancedSettingsService {
    ...
    private List<Definition> definitions() {
        ...
        return List.of(
                ...
                bool("sharing", "nas.share.default-preview-enabled", "shareDefaultPreviewEnabled", "Default shared previews", "Show supported file previews on public share pages. Preview panels start collapsed.", ApplyMode.RUNTIME,
                ...
                bool("tasks", "nas.tasks.activity-panel-enabled", "taskActivityPanelEnabled", "Task activity", "Show background task progress in the Topbar task list.", ApplyMode.RUNTIME,
                        tasks::isActivityPanelEnabled, tasks::setActivityPanelEnabled),
                scaledDecimal("tasks", "nas.tasks.completed-display-ms", "taskCompletedDisplaySeconds", "Completed task display time", "How long completed tasks remain visible in the Topbar task list.", "seconds", BigDecimal.ZERO, new BigDecimal("3600"), new BigDecimal("0.1"), 1000L, ApplyMode.RUNTIME,
    ...
    private static List<GroupMetadata> groupMetadata() {
        return List.of(
                ...
                new GroupMetadata("tasks", "Background Tasks", "Task history, worker concurrency, and Topbar activity timing."),
